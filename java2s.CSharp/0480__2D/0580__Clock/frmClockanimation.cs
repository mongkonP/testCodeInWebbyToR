...
namespace java2s.CSharp.C0480__2D.C0580__Clock
{
    ...
    public partial  class frmClockanimation:Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "frmClockanimation";
            this.Text = "frmClockanimation";
            this.Load += new System.EventHandler(this.frmClockanimation_Load);
        ...
        private void frmClockanimation_Load(object sender, EventArgs e)
        {
        ...
        private class LtrDraw
        {
            ...
            public void DrawString(Graphics g, Brush brush, frmClockanimation cf)
            {
                Font font = cf.font;
        ...
        private class StringDraw
        {
            ...
            public void DrawString(Graphics g, Brush brush)
            {
                ...
                foreach (LtrDraw theLtr in theString)
                {
                    ...
                    float newX = GetCos(angle * counter + 90 - frmClockanimation.Offset) * frmClockanimation.DateRadius;
                    float newY = GetSin(angle * counter + 90 - frmClockanimation.Offset) * frmClockanimation.DateRadius;
                    theLtr.X =
                ...
                frmClockanimation.Offset += 1;  // rotate the entire string
            }
        }
